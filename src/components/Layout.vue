  ...
  <div class="container slim_scrollbar">
    ...
    <div class="side" v-if="has_menu && layout_type">
      <mu-drawer :docked="docked" :open="open" @close="openMenu()">
        ...
        <mu-list>
          <mu-list-item :title="nav.title" :to="nav.value" v-for="nav in bottom_nav" :key="nav.title"
                        @click="openMenu()">
      ...
      <template>
        <mu-paper>
          <mu-bottom-nav :value="active_nav" @change="handleChange">
            <mu-bottom-nav-item :value="nav.value" :title="nav.title" :icon="nav.icon" v-for="nav in bottom_nav"
                                :key="nav.title"/>
          </mu-bottom-nav>
        </mu-paper>
      </template>
