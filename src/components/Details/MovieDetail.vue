          ...
          <div class="comments_box">
            ...
            <div class="list">
              ...
              <div class="showmore" @click="jumpAllHotComments"
                   style="text-align: right;cursor: pointer;padding: 10px;color: blue;"><span>查看全部{{totalCount}}条精选影评&gt;&gt;</span>
              </div>
            </div>
...
<script>
  ...
  import {moviedetail, hotcomment, comment} from '../../api/data'
  ...
  export default {
    ...
    mounted() {
      ...
      console.log('mounted', '>>>>moviedetail.vue')
    },
    activated() {
      if (this.scroll >= 0) {
      ...
      console.log('activated', '>>>>moviedetail.vue')
    },
    deactivated() {
      window.removeEventListener('scroll', this.handleScroll);
      console.log('deactivated', '>>>>moviedetail.vue')
    },
    methods: {
      handleScroll() {
      ...
      getHotLongComments() {
        _self.hot_comments_list = hotcomment.comments
      },
      getMovieComments() {
        _self.comments_list = comment.cts
      },
      loadMore() {
